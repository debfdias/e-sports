...
export function AdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try {
      const response = await api.post(`/ads/game/${data.game}`, {
        name: data.name,
          ...
          <Dialog.Title className='text-3xl font-black'>
            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <Input id="name" name="name" placeholder='How we find you?'/>
              </div>

              <div className='grid grid-cols-2 gap-10'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='yearsPlaying'>Years playing it?</label>
                  <Input id="yearsPlaying" name="yearsPlaying" type="number" placeholder='Okay being a newbie'/>
                </div>
              ...
              <div className='flex gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='weekDays'>Which days of week u play?</label>
                  <ToggleGroup.Root
                    type="multiple"
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  <label htmlFor='hourStart'>Time of the day?</label>
              ...
              <footer className='flex mt-4 justify-end gap-4'>
                <Dialog.Close type="button" className='bg-zinc-500 rounded-md font-semibold px-5 h-12 hover:bg-zinc-600'>Cancel</Dialog.Close>
                <button className='bg-violet-500 rounded-md font-semibold px-5 h-12 flex items-center gap-3 hover:bg-violet-600' type="submit">
